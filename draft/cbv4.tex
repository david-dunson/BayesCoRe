...
\begin{align*}
\pi_\mathcal{D}(\theta_1,\theta_2)&= \pi(\theta_1,\theta_2|\theta\in\mathcal{D})= \frac{\exp\bigg(-\frac{||\theta||^2}{2\sigma^2}\bigg)\mathbbm{1}_\mathcal{D}(\theta)}{\int_0^1\int_0^{1-\theta_1}\exp\bigg(-\frac{||\theta||^2}{2\sigma^2}\bigg)d\theta_2d\theta_1}\\
&\propto \exp\bigg(-\frac{||\theta||^2}{2\sigma^2}\bigg) \mathbbm{1}_{\{\theta_1+\theta_2\le 1\}\cap \{\theta_1 \in [0,\infty)\}\cap \{\theta_2\in[0,\infty)\}} .
\end{align*}
