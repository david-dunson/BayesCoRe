afarray qnorm(afarray p, afarray mu, afarray sigma)
{
    ...
    { /* closer than 0.075 from {0,1} boundary */
        ...
        afarray rL5bool = r <= 5.;
        if (anyTrue<bool>(rL5bool))
        { /* <==> min(p,1-p) >= exp(-25) ~= 1.3888e-11 */

            afarray rL5 = r(rL5bool);
            rL5 += -1.6;
            valNOTfabsq425(rL5bool) =
                (((((((rL5 * 7.7454501427834140764e-4 + .0227238449892691845833) * rL5 +
                ...
                (((((((rL5 * 1.05075007164441684324e-9 + 5.475938084995344946e-4) * rL5 +
